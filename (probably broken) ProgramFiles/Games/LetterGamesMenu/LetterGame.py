...
class LetterGrid(GridLayout):
    ...
    def __init__(self,**kwargs):
        ...
        #print('Letter Grid children:',self.children)
...
class GameBoard(BoxLayout):
    ...
    def exit(self):
        print(sys.getrefcount(LetterGrid))
        print('This is before the remove in the exit function',self.children[1].children[0].children[1].children[0])
        [self.children[1].children[0].children[1].children[0].remove_widget(child) for child in self.children[1].children[0].children[1].children[0].children]
        self.children[1].children[0].children[1].remove_widget(self.children[1].children[0].children[1].children[0])
        print('This is after the remove in the exit function',self.children[1].children[0].children[1].children)
        #print(self.children[1].children[0].children[1].children[0].ids)
        Window.fullscreen = False
        self.parent.parent.current = 'select'
        
    def addHomeRow(self):
        if self.addedHomeRow:
            self.children[1].children[0].children[1].children[0].children[0].letters = [i for i in self.children[1].children[0].children[1].children[0].children[0].letters if i not in ('a','s','d','f','j','k','l',';')]
            if len(self.children[1].children[0].children[1].children[0].children[0].letters) == 0:
                self.children[1].children[0].children[1].children[0].children[0].letters.append(' ')
                self.ids.BeginButton.disabled = True
                self.ids.Cap.disabled = True
            self.addedHomeRow = False
            self.children[1].children[0].children[1].children[0].children[0].makeAnswers()
            self.children[1].children[0].children[1].children[0].children[0].fillLetters()
            return


        if self.children[1].children[0].children[1].children[0].children[0].letters[0] == ' ':
            self.children[1].children[0].children[1].children[0].children[0].letters = ['a','s','d','f','j','k','l',';']
        else:
            self.children[1].children[0].children[1].children[0].children[0].letters.extend(('a','s','d','f','j','k','l',';'))
        self.children[1].children[0].children[1].children[0].children[0].makeAnswers()
        self.children[1].children[0].children[1].children[0].children[0].fillLetters()
        self.ids.BeginButton.disabled = False
