...
#Define functions to use in the program later
    ...
    def calculateRealWPM(self):
        self.realWPM = int((self.lettersRight.count(True)/5)/(self.totalTime-self.time)*60)

    def calculateAccuracy(self):
        self.accuracy = int(self.lettersRight.count(True)/self.lettersTyped*100) if self.lettersTyped else 0
